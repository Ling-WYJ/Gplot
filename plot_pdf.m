...
function draw_arrow(start_pos, end_pos, weight)
    % 绘制弧线
    quiver(start_pos(1), start_pos(2), end_pos(1) - start_pos(1), end_pos(2) - start_pos(2), 0, 'MaxHeadSize', 0.2, 'Color', 'k');
    ...
    % 在弧线中点显示权重
    text(mid_pos(1), mid_pos(2), num2str(weight), 'HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom', 'FontSize', 15, 'Color', 'r');
end
